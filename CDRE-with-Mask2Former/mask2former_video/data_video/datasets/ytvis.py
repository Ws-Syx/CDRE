...
"""
    ...
    #  'gt_names': ['ff25f55852/00000.jpg', 'ff25f55852/00005.jpg', ..., 'ff25f55852/00175.jpg'],
    #  'height': 720,
    #  'width': 1280,
    #  'length': 36,
    ...
    for (vid_dict, anno_dict_list) in vids_anns:
        ...
        record["gt_names"] = [os.path.join(image_root, vid_dict["gt_names"][i]) for i in range(vid_dict["length"])]
